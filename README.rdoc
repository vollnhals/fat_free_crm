=== Welcome to Fat Free CRM with Magic!
...
* Git source code repository: git://github.com/vollnhals/fat_free_crm.git
* .zip or .tgz archives: http://github.com/vollnhals/fat_free_crm/downloads
